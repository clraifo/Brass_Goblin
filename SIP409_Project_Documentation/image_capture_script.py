# This script is used to capture a lot of images in a relatively short time
# for use in training the image classification model. It stored them locally
# on the rPi and from there I dropped them into a google drive folder.
...
STEPS_FOR_2_25_INCHES = 19000  # Number of microsteps to move 2.25 inches

# Initialize the camera
camera = PiCamera()
camera.resolution = (400, 380)
...
def main():
    try:
        ...
        while True:
            ...
            camera.capture(f'/home/clraifo/camera/training_images/LC_lighting_100/LC_{image_counter:03d}.jpg')
